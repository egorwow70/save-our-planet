...
import { RegistrationFormInterface } from 'src/app/models/user-list/registration-form-interface';
import { RegistrationType } from 'src/app/models/user-list/registration-type';
