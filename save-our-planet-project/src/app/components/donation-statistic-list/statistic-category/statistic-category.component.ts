...
import { FacadeServiceDonationStatisticList } from 'src/app/store/donation-statistic-list/donation-statistic-list.facade';
...
} from 'src/app/store/donation-statistic-list/donation-statistic-list.selectors';
import { DonationStatisticInterface } from 'src/app/models/donation-statistic-list/donation-statistic-interface';
import { selectUserList } from 'src/app/store/user-list/user-list.selectors';
import { selectDonationList } from 'src/app/store/donation-list/donation-list.selectors';
import { User } from 'src/app/models/user-list/user';
import { Donation } from 'src/app/models/donation-list/donation';
import { StatisticCategoryType } from 'src/app/models/donation-statistic-list/statistic-category-type';
